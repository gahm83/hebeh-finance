...
export default function Simulador() {
  ...
  return (
    <section className="bg-[#051b38] text-white pt-12 pb-32 lg:py-24 px-6 z-10">
      ...
      <form
        ...
        <div className="grid grid-cols-12 lg:flex lg:items-center lg:justify-center gap-y-3">
          ...
          <div className="col-span-4">
            <a className="button rounded-l-none lg:px-6" onClick={() => handleCalculation()}><span>Calcular</span></a>
          </div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 grid grid-cols-10 gap-1 lg:gap-3">
            <div className="bg-slate-200 text-black col-span-3 flex flex-col justify-center text-center py-3 lg:py-0 rounded-l-md">
              <h3 className="font-bold leading-tight px-4 lg:px-6">Plazos en meses</h3>
              {
            ...
            <div className="bg-slate-200 text-black col-span-4 flex flex-col justify-center text-center py-3 lg:py-0">
            ...
            <div className="bg-slate-200 text-black col-span-3 flex flex-col justify-center text-center py-3 lg:py-0 rounded-r-md">
              <h3 className="font-bold leading-tight px-4 lg:px-6">Tasa de Interés</h3>
              {
                (planDePagos && planDePagos.length !== 0) &&
                <div className="flex flex-col mt-3">
                {
          ...
          <div className="lg:col-span-5">
            <h3 className="text-xl lg:text-2xl font-bold text-center mb-3">Mándanos tus datos para sanar tu cuenta bancaria</h3>
