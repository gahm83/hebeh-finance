...
export default function NuestraEmpresa() {
  const accordionData = [
    ...
    {
      title: 'Valores',
      content: '<p><strong>Integridad</strong> Nos comprometemos a actuar con honestidad, transparencia y ética en todas nuestras interacciones con clientes, empleados y socios comerciales. Valoramos la confianza que nuestros clientes depositan en nosotros y nos esforzamos por mantenerla en todo momento.</p><p> <strong>Innovación:</strong> Buscamos constantemente nuevas formas de mejorar y optimizar nuestros servicios financieros.Fomentamos un entorno de creatividad y colaboración, donde se valora la generación de ideas y la implementación de soluciones tecnológicas que mejoren la experiencia del cliente.</p><p><strong>Excelencia:</strong> Nos esforzamos por ofrecer un servicio de calidad excepcional en todas las interacciones con nuestros clientes. Buscamos la excelencia en cada aspecto de nuestro negocio, desde la atención al cliente, hasta la seguridad de sus datos financieros. Nos comprometemos a brindar una experiencia fluida y satisfactoria en cada paso del proceso.</p><p><strong>Responsabilidad:</strong> Reconocemos nuestra responsabilidad como actores en el sector financiero y nos comprometemos a cumplir con todas las regulaciones y requisitos legales y fiscales aplicables. Valoramos la gestión responsable del riesgo y nos esforzamos por educar a nuestros clientes sobre las mejores prácticas en el manejo de sus finanzas.</p>'
    },
  ]
  return (
